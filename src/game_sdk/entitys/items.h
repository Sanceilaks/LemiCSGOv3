...
{
public:
	NETVAR("DT_WeaponBaseItem", "m_iItemDefinitionIndex", get_item_definition_index, int);
	NETVAR_PTR("DT_BaseAttributableItem", "m_szCustomName", get_custom_name, char);

	
};

class CWeapon : public CAttributableItem
{
public:
	...
	NETVAR("DT_WeaponCSBaseGun", "m_zoomLevel", get_zoom_level, int);
