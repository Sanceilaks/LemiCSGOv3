...
public:
	...
	/// <summary>
	/// Auto translate vector to angle
	/// </summary>
	/// <param name="right">Any Vector</param>
	/// <returns>Pointer to this</returns>
	QAngle& operator=(const Vector& right)
	{
		QAngle ret;
		vector2angles(right, ret);

		pitch = ret.pitch; yaw = ret.yaw; roll = ret.roll;
		return *this;
	}
