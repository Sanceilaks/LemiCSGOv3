...
public:
	...
	matrix3x4_t& as3_x4();
	const matrix3x4_t& as3_x4() const;
	void  copy_from3_x4(const matrix3x4_t& m3x4);
	void  set3_x4(matrix3x4_t& matrix3x4) const;
...
public:
	...
	Vector  v_mul3_x3(const Vector& vVec) const;

	// Apply the inverse (transposed) rotation (only works on pure rotation matrix)
	Vector  v_mul3_x3_transpose(const Vector& vVec) const;

	// Multiply by the upper 3 rows.
	Vector  v_mul4_x3(const Vector& vVec) const;

	// Apply the inverse (transposed) transformation (only works on pure rotation/translation)
	Vector  v_mul4_x3_transpose(const Vector& vVec) const;
