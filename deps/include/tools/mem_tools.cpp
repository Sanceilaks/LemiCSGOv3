...
void* mem_tools::capture_interface(const char* _module, const char* _interface)
{
    const Interface tempInterface = reinterpret_cast<Interface>(GetProcAddress(
        GetModuleHandle(_module), "CreateInterface"));
